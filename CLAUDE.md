...
- **Read `.claude/learn/LEARNINGS.md` at the start of work on this repo.** It is short by design (60-line cap). A planned `SessionStart` hook will inject it automatically; until that hook exists, reading it is your job.
