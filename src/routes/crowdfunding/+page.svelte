<script lang="ts">
    ...
    import CampaignFilter from './components/CampaignFilter.svelte';
    ...
    const campaigns: Campaign[] = [
        {
            ...
            description: 'Help me create my debut album with 12 original tracks and professional production',
            goal: 15000,
            raised: 12500,
            backers: 342,
            daysLeft: 15,
            ...
            isVerified: true,
            rewards: [
                { id: '1', title: 'Digital Download', description: 'Full album MP3', amount: 5 },
                { id: '2', title: 'Vinyl Copy', description: 'Limited edition vinyl', amount: 25, quantity: 500, claimed: 245 },
        ...
        },
        {
            ...
            isVerified: true,
            rewards: [
                { id: '1', title: 'Digital Single', description: 'MP3 + WAV format', amount: 3 },
                { id: '2', title: 'Credit in Song', description: 'Your name in the credits', amount: 15 }
            ]
        },
        {
            id: '3',
            ...
            isVerified: true,
            rewards: [
                { id: '1', title: 'Concert Ticket', description: 'General admission ticket', amount: 35 },
                { id: '2', title: 'VIP Package', description: 'Front row + meet & greet', amount: 150, quantity: 100, claimed: 47 }
            ]
        },
        {
            id: '4',
            ...
            isVerified: true,
            rewards: [
                { id: '1', title: 'Festival Pass', description: '2-day pass', amount: 50 },
                { id: '2', title: 'VIP Experience', description: 'VIP area + merchandise', amount: 200, quantity: 500, claimed: 287 }
            ]
        },
        {
            id: '5',
            ...
            isVerified: false,
            rewards: [
                { id: '1', title: 'Digital Album', description: 'Full album download', amount: 8 },
                { id: '2', title: 'Exclusive Content', description: 'Behind the scenes footage', amount: 30 }
            ]
        }
    ];
...
<div class="crowdfunding-page">
    ...
    <section class="crowdfunding-hero">
        ...
        <div class="hero-content">
            ...
            <p class="hero-subtitle">Support artists and receive exclusive rewards. Together we create amazing music.</p>
        ...
        <main class="campaigns-main">
            ...
            <div class="search-section">
                <div class="search-box">
                    ...
                    />
                    <SvgIcon path={mdiFilterOutline} size={18} class="search-box__icon" />
                </div>
            </div>

            <!-- Campaign Type Info -->
            <div class="campaign-types-info">
                <div class="type-badge" title="Album">
                    <SvgIcon path={mdiMusicBox} size={16} />
                    <span>Albums</span>
                </div>
                <div class="type-badge" title="Song">
                    <SvgIcon path={mdiMicrophone} size={16} />
                    <span>Songs</span>
                </div>
                <div class="type-badge" title="Concert">
                    <SvgIcon path={mdiTicket} size={16} />
                    <span>Concerts</span>
                </div>
                <div class="type-badge" title="Festival">
                    <SvgIcon path={mdiTrendingUp} size={16} />
                    <span>Festivals</span>
                </div>
            </div>
