<script lang="ts">
	...
	import { mdiTrendingUp, mdiCurrencyUsd, mdiCheckCircle } from '@mdi/js';
	...
	const referralData = $state({
		...
		qrCode:
			'https://api.qrserver.com/v1/create-qr-code/?size=300x300&data=https://pdm.music/ref/johndoe2024',
		totalReferrals: 47,
		activeReferrals: 35,
	...
	<section class="affiliate-header">
		<div class="affiliate-header__content">
			<div>
				...
				<p class="affiliate-header__subtitle">Earn money by inviting friends to PDM Music</p>
			</div>
	...
	<section class="affiliate-section">
		<div class="balance-info">
			...
			<div class="balance-info__content">
				<p>
					All affiliate earnings are automatically credited to your platform balance at the end of
					each month. You can use your balance to:
				</p>
				...
				<div class="balance-note">
					<p>
						<strong>Note:</strong> Your balance is stored securely on the platform and can be managed
						from your account settings. Balance transactions are tracked in your payment history for
						full transparency.
					</p>
				</div>
			</div>
