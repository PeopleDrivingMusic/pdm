...
export const trackStats = pgTable(
	'track_stats',
	{
		id: uuid().defaultRandom().primaryKey().notNull(),
...
export const artistOnboardingRequests = pgTable(
	'artist_onboarding_requests',
	{
		id: uuid().defaultRandom().primaryKey().notNull(),
		userId: uuid('user_id').notNull(),
		name: varchar({ length: 100 }).notNull(),
...
export const artistSessions = pgTable(
	'artist_sessions',
	{
		id: text().primaryKey().notNull(),
...
// Artist videos table
export const artistVideos = pgTable(
	'artist_videos',
	{
		id: uuid().defaultRandom().primaryKey().notNull(),
		artistId: uuid('artist_id').notNull(),
...
// Artist photos table
export const artistPhotos = pgTable(
	'artist_photos',
	{
		id: uuid().defaultRandom().primaryKey().notNull(),
		artistId: uuid('artist_id').notNull(),
...
// Artist posts table
export const artistPosts = pgTable(
	'artist_posts',
	{
		id: uuid().defaultRandom().primaryKey().notNull(),
		artistId: uuid('artist_id').notNull(),
